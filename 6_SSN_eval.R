...
working_dir <- file.path("C:/") #Your grass file path
...
preds_path <- paste0(Myfiles,"Kinzig_PA_evaluation.gpkg")
...
preds_o <- readVECT("Kinzig_PA_evaluation_o", ignore.stderr = TRUE)
...
calc_sites(predictions = "Kinzig_PA_evaluation_o")
pred_sites <- readVECT("Kinzig_PA_evaluation", ignore.stderr = TRUE)
...
calc_attributes_sites_approx(sites_map = "Kinzig_PA_evaluation",
                             input_attr_name = c('LUp_1_1_015686', 'LUp_1_988235_2_003922', 'LUp_2_992157_3_007843', 'LUp_3_996078_4_011765', 'LUp_4_984314_5', "Elev"),
                             output_attr_name = c(paste0(rep("LU",5),1:5), "Elev"),
                             stat = c(rep("percent",5), "mean"), overwrite = TRUE)
sites <- readVECT("sites", ignore.stderr = TRUE)
...
ssn_dir_kinzig <- file.path(Myfiles, "Eval.ssn")
export_ssn(ssn_dir_kinzig, predictions = "Kinzig_PA_evaluation", delete_directory = TRUE)
